...
The artifact is built from this [commit](https://github.com/keigoi/kmclib/tree/ce013f6) in the [kmclib GitHub repository](https://github.com/keigoi/kmclib).
...
* **Progress errors**
   ...
   * Comment out [Line 31](https://github.com/keigoi/kmclib/blob/55a9baa11db02931cbee2983f11cb836bb31ea0c/examples/paper/fib.ml#L31).   
  
       - After the edit [Line 31](https://github.com/keigoi/kmclib/blob/55a9baa11db02931cbee2983f11cb836bb31ea0c/examples/paper/fib.ml#L31) should be: 
       ```ocaml 
...
* **Eventual Reception errors**
   ...
   * Comment out [Line 35](https://github.com/keigoi/kmclib/blob/55a9baa11db02931cbee2983f11cb836bb31ea0c/examples/paper/fib.ml#L35) and modify [Line 36](https://github.com/keigoi/kmclib/blob/55a9baa11db02931cbee2983f11cb836bb31ea0c/examples/paper/fib.ml#L36) as follows:
       - [Line 35](https://github.com/keigoi/kmclib/blob/55a9baa11db02931cbee2983f11cb836bb31ea0c/examples/paper/fib.ml#L35) should be 
       ```ocaml 
       (* let `result(r2, mch) = receive mch#w in *)
       ```
       - [Line 36](https://github.com/keigoi/kmclib/blob/55a9baa11db02931cbee2983f11cb836bb31ea0c/examples/paper/fib.ml#L36) should be loop
       ```ocaml 
...
* **Format (Type mismatch) errors**
   ...
   * Wrong send/receive signatures
       - Modify [Line 9](https://github.com/keigoi/kmclib/blob/55a9baa11db02931cbee2983f11cb836bb31ea0c/examples/paper/fib.ml#L9) by removing one of the parameters of send, for example delete #m. After the edit [Line 9](https://github.com/keigoi/kmclib/blob/55a9baa11db02931cbee2983f11cb836bb31ea0c/examples/paper/fib.ml#L9) should be `let uch = send uch#compute 42 in`
   ...
   * Mismatch between send and receive labels.
       ...
       - Option 2: Misspell `wip` to `wipe` on [Line 12](https://github.com/keigoi/kmclib/blob/55a9baa11db02931cbee2983f11cb836bb31ea0c/examples/paper/fib.ml#L12)

   * Mismatch on payload types
       - Modify 42 on [Line 9](https://github.com/keigoi/kmclib/blob/55a9baa11db02931cbee2983f11cb836bb31ea0c/examples/paper/fib.ml#L9) to “42”
